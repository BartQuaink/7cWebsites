  ...
  function (declare, BaseWidget, Evented, _OnDijitClickMixin, _WidgetsInTemplateMixin,
    ...
    return declare([BaseWidget, _OnDijitClickMixin, _WidgetsInTemplateMixin, Evented], {
      ...
      _initMeasureTool: function () {
        ...
        aspect.after(this.measureTool, 'setTool', lang.hitch(this, function () {
          if (this.measureTool.activeTool) {
            this.sceneView.setInfoWindowOnClick(false);
            this.disableWebMapPopup();
          } else {
            this.sceneView.setInfoWindowOnClick(true);
      ...
      disableWebMapPopup: function () {
        if (this.sceneView && this.sceneView.webMapResponse) {
          var handler = this.sceneView.webMapResponse.clickEventHandle;
          if (handler) {
            handler.remove();
            this.sceneView.webMapResponse.clickEventHandle = null;
          }
        }
      },
      ...
      enableWebMapPopup: function () {
        if (this.sceneView && this.sceneView.webMapResponse) {
          var handler = this.sceneView.webMapResponse.clickEventHandle;
          var listener = this.sceneView.webMapResponse.clickEventListener;
          if (listener && !handler) {
            this.sceneView.webMapResponse.clickEventHandle = on(
              this.sceneView,
              'click',
              lang.hitch(this.sceneView, listener)
            );
          }
        }
      },
      ...
      _onMeasureClick: function () {
        ...
        this.sceneView.infoWindow.clearFeatures();
        this.sceneView.infoWindow.hide();
      ...
      _initProfileService: function () {
        ...
        if (this.profileServiceUrl) {
          ...
          esriRequest({
            ...
            this.profileService.setOutSpatialReference(this.sceneView.spatialReference);
      ...
      _createProfileChart: function (elevationInfo) {
        ...
        if (!elevationInfo) {
          ...
          // SAMPLING DISTANCE //
          this.samplingDistance.distance = (this.sceneView.extent.getWidth() / this.samplingPointCount);
      ...
      _displayChartLocation: function (chartObjectX) {
        if (this.sceneView && this.elevationData && this.profilePolyline) {
